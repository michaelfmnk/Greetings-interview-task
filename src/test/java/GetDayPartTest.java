...
import static com.michaelfmnk.greeting.DayPart.MORNING;
...
public class GetDayPartTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { 0, NIGHT }, { 17, DayPart.DAYTIME}, {24, NIGHT}, {20,EVENING}, {8, MORNING}
        });
    }
    ...
    @Test
    public void testDayParts() throws Exception{
